...
router.patch('/:id', authenticate, isProvider, appointmentTypeController.updateAppointmentType);
router.delete('/:id', authenticate, isProvider, appointmentTypeController.deleteAppointmentType);
