...
const requestPasswordReset = async (req, res) => {
  ...
  if (!user) {
    ...
    return ok(res, 'If an account exists for this email, we have sent a reset code');
  }
  ...
  if (!emailResult.success) {
    return badRequest(res, 'Failed to send password reset email. Please try again.');
  }

  return ok(res, 'Password reset code sent to your email', {
    email,
...
const resetPasswordWithOTP = async (req, res) => {
  ...
  return ok(res, 'Password reset successful. You can now log in with your new password.');
};
