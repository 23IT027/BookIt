...
const organiserLinks = [
  ...
  { name: 'Services', href: '/organiser/appointment-types', icon: CalendarDays },
  { name: 'Availability', href: '/organiser/availability', icon: Clock },
  { name: 'Bookings', href: '/organiser/bookings', icon: Calendar },
  { name: 'Booking Link', href: '/organiser/booking-link', icon: Link2 },
...
export function Sidebar({ type = 'organiser' }) {
  ...
  const links = type === 'admin' ? adminLinks : organiserLinks;
